...
{
    led = LED_RGB(	STM32::GPIO(LED_RED_PORT, LED_RED_PIN, STM32::out),
							STM32::GPIO(LED_GREEN_PORT, LED_GREEN_PIN, STM32::out),
							STM32::GPIO(LED_BLUE_PORT, LED_BLUE_PIN, STM32::out));
}
